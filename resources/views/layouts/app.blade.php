    ...
    <div class="flex h-screen w-full">
                    ...
                    @if(auth()->check() && auth()->user()->role == 'admin')
                        ...
                        <!-- Dashboard -->
                                <a href="{{ route('admin.dashboard') }}" 
                                    class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.dashboard') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                        ...
                        <a href="{{ route('admin.user.index') }}"
                            class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.user.*') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.user.*') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.kategori.index') }}"
                            class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.kategori.*') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.kategori.*') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.alat.index') }}"
                            class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.alat.*') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.alat.*') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.peminjaman.index') }}"
                            class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.peminjaman.*') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('admin.peminjaman.*') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.pengembalian.index') }}" 
                            class="group flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 {{ request()->routeIs('admin.pengembalian.*') ? 'bg-gray-800 text-white font-medium shadow' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                                
                                <svg class="w-5 h-5 {{ request()->routeIs('admin.pengembalian.*') ? 'text-blue-400' : 'text-gray-400 group-hover:text-blue-400' }} transition-colors duration-200" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="bg-white border-b border-slate-100 h-16 flex justify-between items-center px-6 shrink-0 shadow-sm">
                ...
                @auth
                    <form action="{{ route('logout') }}" method="POST" onsubmit="return confirm('Apa yakin anda akan logout?')">
                        @csrf
                        <button
                            type="submit"
